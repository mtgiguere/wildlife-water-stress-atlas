...
def test_export_country_counts_writes_geojson(tmp_path):
    ...
    with patch("scripts.export_country_aggregates.load_countries", return_value=mock_countries), \
         patch("scripts.export_country_aggregates.gpd.read_file", return_value=mock_occurrences):
